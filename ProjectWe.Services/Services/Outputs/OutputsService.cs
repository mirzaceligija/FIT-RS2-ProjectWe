...
namespace ProjectWe.Services.Services.Outputs
{
    public class OutputsService : BaseCRUDService<Models.Output, Output, OutputSearchObject, OutputInsertRequest, OutputUpdateRequest>, IOutputsService
    {
